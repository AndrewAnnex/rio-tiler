...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/x.geotiff', 'image/tiff; profile=cloud-optimized; application=geotiff', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/jp2', 'application/x-hdf', 'image/tiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'application/x-hdf5', 'image/tiff; application=geotiff'},
